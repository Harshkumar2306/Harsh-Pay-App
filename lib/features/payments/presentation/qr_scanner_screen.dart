...
class _QRScannerScreenState extends State<QRScannerScreen> {
  ...
  void _processSuccessPayload(Map<String, dynamic> payload) async {
    ...
    // NOTE: We DO NOT add to wallet.syncedBalance here! 
    // The balance will only update after Zero-Trust verification completes on the backend during sync.
    ...
    if (!mounted) return;
    _showSuccessDialog(
      '✅ Claimed ₹${amount.toStringAsFixed(0)} offline!\n\n(Pending verification from sender during sync)',
      isOnline: false,
    );
  }
